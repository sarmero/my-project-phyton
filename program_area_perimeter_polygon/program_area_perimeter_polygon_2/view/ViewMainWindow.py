...
class MainWindow(QMainWindow):
    ...
    def resizeEvent(self, event):
        self.__move_right(self.lab_code, 134)
        self.__move_right(self.lab_points, 134)
        self.__move_right(self.lab_perimeter, 184)
        self.__move_right(self.lab_area, 184)
        self.__move_right(self.com_code, 214)
        self.__move_right(self.tab_point, 114)
        self.__move_right(self.tex_perimeter, 134)
        self.__move_right(self.tex_area, 134)
        self.__move_right(self.but_update, 134)
        self.__move_right(self.lab_point, 184)
        self.__move_right(self.but_color_point, 184)
        self.__move_right(self.lab_line, 184)
        self.__move_right(self.but_color_line, 184)
        self.__move_right(self.lab_zoom, 184)
        self.__move_right(self.but_scale_increase, 184)
        self.__move_right(self.but_scale_decrease, 134)

        n = self.width() - 314

        canvas = QPixmap(n, 690)
        canvas.fill(Qt.white)
        self.lab_canvas.setGeometry(QRect(20, 55, n, 690))
        self.lab_canvas.setPixmap(canvas)
        self.__init_canvas()
    ...
    def __move_right(self, component, size):
        geo = component.geometry()
        geo.moveRight(self.width() - size + 30)
