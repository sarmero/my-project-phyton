...
class MainWindow(QMainWindow):
    ...
    def __launch_Events(self):
        ...
        self.but_update.clicked.connect(self.__list_code)
    ...
    def __list_code(self):
        self.com_code.clear()

        for i in range(self.__vector_polygon.get_size()):
            self.com_code.addItem(
                str(self.__vector_polygon.array_polygons[i].code))
    ...
    def __draw_polygon(self, quantity_point, point_x, point_y):
        ...
        pen_line = QPen(QColor(0, 0, 255), 1, Qt.SolidLine)
